...
public class HttpTaskResponse
{
    ...
    private HttpTaskResponse(final HttpTaskResponse.Status status)
    {
        this.status = status;
    }
    
    private HttpTaskResponse(final HttpTaskResponse.Status status, final String data)
    {
        this.status = status;
        this.data = data;
    }
    ...
    {
        return new HttpTaskResponse(HttpTaskResponse.Status.Success, content);
    }

    public boolean isSuccess()
    {
        return status == HttpTaskResponse.Status.Success;
    }
